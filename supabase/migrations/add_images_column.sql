...
COMMENT ON COLUMN needs.images IS 'Array of Supabase Storage URLs for uploaded images (max 3). Images are auto-compressed to 800px/500KB for sustainability.';
